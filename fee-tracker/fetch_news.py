...
QUERIES = [
    ...
    "Victoria BC development cost charge",
    "Nanaimo development cost charge bylaw",
    "Courtenay Comox development cost charge",
    "Langford Colwood development cost charge",
    "Capital Regional District water DCC",
]
...
def guess_tag(item: dict) -> str:
    ...
    for muni in ("surrey", "burnaby", "richmond", "coquitlam",
                 "new westminster", "langley", "delta", "victoria",
                 "nanaimo", "parksville", "courtenay", "comox",
                 "langford", "colwood", "duncan", "vancouver"):
        if muni in blob:
            return muni.title()
    return "Regional"
