...
def payload_from_seed():
    ...
    return {
        ...
        "sources": S.SOURCES,
        "islandDCC": S.ISLAND_DCC,
        "islandRegional": S.ISLAND_REGIONAL,
        "upcoming": UPCOMING,
    }
...
UPCOMING = [
    ...
    {"date": "2028-01-01", "what": "Metro Vancouver new DCC program",
     ...
     "impact": "low"},
    {"date": "2026-06-01", "what": "Comox Valley CVRD sewer fee changes",
     "detail": "CVRD Bylaw 71 sewerage fee changes take effect; sewer DCCs collected by "
               "Courtenay and Comox increase.",
     "impact": "medium"},
    {"date": "2027-01-01", "what": "Nanaimo Bylaw 7438 takes effect",
     "detail": "Nanaimo single-family DCC nearly triples, from ~$14,862 to ~$42,887/lot, "
               "plus a new ACC and South Nanaimo area-specific transportation DCC. "
               "Adoption planned January 2027.",
     "impact": "high"},
    {"date": "2027-04-02", "what": "CRD Regional Water Supply DCC starts",
     "detail": "New CRD-wide water DCC (~$9,044/single-family lot) layers on top of "
               "municipal charges across Victoria, Langford, Colwood and other CRD "
               "members. Awaiting Inspector of Municipalities approval.",
     "impact": "high"},
]
